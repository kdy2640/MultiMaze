...
namespace MazeClient
{
    public partial class WaitScene : Form
    {
        ...
        class WaitSceneArgs
        {
            ...
            public byte[][] chatBuffer = new byte[4][];
        ...
        private async void ReceiveArgs(byte[] buffer)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                Array.Copy(buffer, 107 * i, colorBuffer, 0, 3);
                Array.Copy(buffer, 107 * i + 3, stateBuffer, 0, 2);
                Array.Copy(buffer, 107 * i + 5, chatBuffer, 0, 100);
            ...
            Array.Copy(buffer, 428 -2, hostBuffer, 0, 2);
